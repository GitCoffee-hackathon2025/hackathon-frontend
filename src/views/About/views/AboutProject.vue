...
const techs: Tech[] = [
  ...
  },
  {
    ...
    logoUri: 'https://www.mysql.com/common/logos/logo.svg'
  },
  {
    id: 'node',
    name: 'Node.js',
  ...
  },
  {
    ...
    logoUri: 'https://raw.githubusercontent.com/vitejs/vite/main/docs/public/logo.svg'
  },
  {
    id: 'fastify',
    name: 'Fastify',
 ...
 */
function svgInnerToDataUri(innerSvg: string, viewBox = '0 0 128 128') {
